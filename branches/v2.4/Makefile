...
# Generated by qmake (2.01a) (Qt 4.7.4) on: dom 29. dez 22:14:41 2013
...
DEFINES	 = -DSYMBIAN -DUNICODE -DQT_KEYPAD_NAVIGATION -DQT_SOFTKEYS_ENABLED -DQT_USE_MATH_H_FLOATS -DVERSAO_FREE -DVERSION="2.4.1" -DQ_COMPONENTS_SYMBIAN -DQT_NO_DEBUG -DQT_DECLARATIVE_LIB -DQT_SQL_LIB -DQT_XMLPATTERNS_LIB -DQT_XML_LIB -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB
...
qmake:
	$(QMAKE) "C:/Repositorio/checkmymeals/CheckMyMeals.pro"  -spec ..\..\QtSDK\Symbian\SDKs\Symbian3Qt474\mkspecs\symbian-sbsv2 CONFIG+=release TIPO_VERSAO=VERSAO_FREE -after  OBJECTS_DIR=obj MOC_DIR=moc UI_DIR=ui RCC_DIR=rcc

bld.inf: C:/Repositorio/checkmymeals/CheckMyMeals.pro
	$(QMAKE) "C:/Repositorio/checkmymeals/CheckMyMeals.pro"  -spec ..\..\QtSDK\Symbian\SDKs\Symbian3Qt474\mkspecs\symbian-sbsv2 CONFIG+=release TIPO_VERSAO=VERSAO_FREE -after  OBJECTS_DIR=obj MOC_DIR=moc UI_DIR=ui RCC_DIR=rcc

c:\Repositorio\checkmymeals\CheckMyMeals_free.loc: 
	$(QMAKE) "C:/Repositorio/checkmymeals/CheckMyMeals.pro"  -spec ..\..\QtSDK\Symbian\SDKs\Symbian3Qt474\mkspecs\symbian-sbsv2 CONFIG+=release TIPO_VERSAO=VERSAO_FREE -after  OBJECTS_DIR=obj MOC_DIR=moc UI_DIR=ui RCC_DIR=rcc

debug: c:\Repositorio\checkmymeals\CheckMyMeals_free.loc bld.inf
...
release: c:\Repositorio\checkmymeals\CheckMyMeals_free.loc bld.inf
...
debug-winscw: c:\Repositorio\checkmymeals\CheckMyMeals_free.loc bld.inf
...
debug-gcce: c:\Repositorio\checkmymeals\CheckMyMeals_free.loc bld.inf
...
debug-armv5: c:\Repositorio\checkmymeals\CheckMyMeals_free.loc bld.inf
	$(SBS) -c armv5_udeb
clean-debug-armv5: bld.inf
	$(SBS) reallyclean -c armv5_udeb
freeze-debug-armv5: bld.inf
	$(SBS) freeze -c armv5_udeb
debug-armv6: c:\Repositorio\checkmymeals\CheckMyMeals_free.loc bld.inf
	$(SBS) -c armv6_udeb
clean-debug-armv6: bld.inf
	$(SBS) reallyclean -c armv6_udeb
freeze-debug-armv6: bld.inf
	$(SBS) freeze -c armv6_udeb
release-gcce: c:\Repositorio\checkmymeals\CheckMyMeals_free.loc bld.inf
...
release-armv5: c:\Repositorio\checkmymeals\CheckMyMeals_free.loc bld.inf
	$(SBS) -c armv5_urel
clean-release-armv5: bld.inf
	$(SBS) reallyclean -c armv5_urel
freeze-release-armv5: bld.inf
	$(SBS) freeze -c armv5_urel
release-armv6: c:\Repositorio\checkmymeals\CheckMyMeals_free.loc bld.inf
	$(SBS) -c armv6_urel
clean-release-armv6: bld.inf
	$(SBS) reallyclean -c armv6_urel
freeze-release-armv6: bld.inf
	$(SBS) freeze -c armv6_urel
debug-armv5-gcce4.4.1: c:\Repositorio\checkmymeals\CheckMyMeals_free.loc bld.inf
	$(SBS) -c arm.v5.udeb.gcce4_4_1
clean-debug-armv5-gcce4.4.1: bld.inf
	$(SBS) reallyclean -c arm.v5.udeb.gcce4_4_1
freeze-debug-armv5-gcce4.4.1: bld.inf
	$(SBS) freeze -c arm.v5.udeb.gcce4_4_1
release-armv5-gcce4.4.1: c:\Repositorio\checkmymeals\CheckMyMeals_free.loc bld.inf
	$(SBS) -c arm.v5.urel.gcce4_4_1
clean-release-armv5-gcce4.4.1: bld.inf
	$(SBS) reallyclean -c arm.v5.urel.gcce4_4_1
freeze-release-armv5-gcce4.4.1: bld.inf
	$(SBS) freeze -c arm.v5.urel.gcce4_4_1
debug-armv6-gcce4.4.1: c:\Repositorio\checkmymeals\CheckMyMeals_free.loc bld.inf
...
release-armv6-gcce4.4.1: c:\Repositorio\checkmymeals\CheckMyMeals_free.loc bld.inf
...
CheckMyMeals_free_template.pkg: C:/Repositorio/checkmymeals/CheckMyMeals.pro
	$(MAKE) -f $(MAKEFILE) qmake

CheckMyMeals_free_installer.pkg: C:/Repositorio/checkmymeals/CheckMyMeals.pro
	$(MAKE) -f $(MAKEFILE) qmake

CheckMyMeals_free_stub.pkg: C:/Repositorio/checkmymeals/CheckMyMeals.pro
	$(MAKE) -f $(MAKEFILE) qmake
...
moc\moc_cvisa.cpp: cconexaodefaultimplementation.h \
		cenumsdefinitions.h \
...
moc\moc_cprocessador.cpp: cenumsdefinitions.h \
		cprocessador.h
...
moc\moc_cmodelorelacaoutilizacao.cpp: cmodelorelacaoutilizacaoitem.h \
	...
	C:\QtSDK\Symbian\SDKs\Symbian3Qt474\bin\moc.exe $(DEFINES) $(INCPATH) -DSYMBIAN c:\Repositorio\checkmymeals\cmodelorelacaoutilizacao.h -o c:\Repositorio\checkmymeals\moc\moc_cmodelorelacaoutilizacao.cpp

moc\moc_cmodelorelacaoutilizacaoitem.cpp: cmodelorelacaoutilizacaoitem.h
	C:\QtSDK\Symbian\SDKs\Symbian3Qt474\bin\moc.exe $(DEFINES) $(INCPATH) -DSYMBIAN c:\Repositorio\checkmymeals\cmodelorelacaoutilizacaoitem.h -o c:\Repositorio\checkmymeals\moc\moc_cmodelorelacaoutilizacaoitem.cpp

moc\moc_cticket.cpp: cconexaodefaultimplementation.h \
		cenumsdefinitions.h \
		cconexaoimplementationspecificinterface.h \
		cticket.h
	C:\QtSDK\Symbian\SDKs\Symbian3Qt474\bin\moc.exe $(DEFINES) $(INCPATH) -DSYMBIAN c:\Repositorio\checkmymeals\cticket.h -o c:\Repositorio\checkmymeals\moc\moc_cticket.cpp

moc\moc_cconexao.cpp: cconexaodefaultimplementation.h \
		cenumsdefinitions.h \
		cvisa.h \
		cconexaoimplementationspecificinterface.h \
		cticket.h \
		cconexao.h
	C:\QtSDK\Symbian\SDKs\Symbian3Qt474\bin\moc.exe $(DEFINES) $(INCPATH) -DSYMBIAN c:\Repositorio\checkmymeals\cconexao.h -o c:\Repositorio\checkmymeals\moc\moc_cconexao.cpp

moc\moc_cconexaodefaultimplementation.cpp: cenumsdefinitions.h \
		cconexaodefaultimplementation.h
	C:\QtSDK\Symbian\SDKs\Symbian3Qt474\bin\moc.exe $(DEFINES) $(INCPATH) -DSYMBIAN c:\Repositorio\checkmymeals\cconexaodefaultimplementation.h -o c:\Repositorio\checkmymeals\moc\moc_cconexaodefaultimplementation.cpp

moc\moc_cenumsdefinitions.cpp: cenumsdefinitions.h
	C:\QtSDK\Symbian\SDKs\Symbian3Qt474\bin\moc.exe $(DEFINES) $(INCPATH) -DSYMBIAN c:\Repositorio\checkmymeals\cenumsdefinitions.h -o c:\Repositorio\checkmymeals\moc\moc_cenumsdefinitions.cpp
...
dodistclean:
	-@ if EXIST "c:\Repositorio\checkmymeals\CheckMyMeals_free_template.pkg" $(DEL_FILE)  "c:\Repositorio\checkmymeals\CheckMyMeals_free_template.pkg"
	-@ if EXIST "c:\Repositorio\checkmymeals\CheckMyMeals_free_stub.pkg" $(DEL_FILE)  "c:\Repositorio\checkmymeals\CheckMyMeals_free_stub.pkg"
	-@ if EXIST "c:\Repositorio\checkmymeals\CheckMyMeals_free_installer.pkg" $(DEL_FILE)  "c:\Repositorio\checkmymeals\CheckMyMeals_free_installer.pkg"
	-@ if EXIST "c:\Repositorio\checkmymeals\Makefile" $(DEL_FILE)  "c:\Repositorio\checkmymeals\Makefile"
	-@ if EXIST "c:\Repositorio\checkmymeals\CheckMyMeals_free_exe.mmp" $(DEL_FILE)  "c:\Repositorio\checkmymeals\CheckMyMeals_free_exe.mmp"
	-@ if EXIST "c:\Repositorio\checkmymeals\CheckMyMeals_free_reg.rss" $(DEL_FILE)  "c:\Repositorio\checkmymeals\CheckMyMeals_free_reg.rss"
	-@ if EXIST "c:\Repositorio\checkmymeals\CheckMyMeals_free.rss" $(DEL_FILE)  "c:\Repositorio\checkmymeals\CheckMyMeals_free.rss"
	-@ if EXIST "c:\Repositorio\checkmymeals\CheckMyMeals_free.loc" $(DEL_FILE)  "c:\Repositorio\checkmymeals\CheckMyMeals_free.loc"
