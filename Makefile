...
# Generated by qmake (2.01a) (Qt 4.7.4) on: qui 28. fev 15:45:49 2013
...
DEFINES	 = -DSYMBIAN -DUNICODE -DQT_KEYPAD_NAVIGATION -DQT_SOFTKEYS_ENABLED -DQT_USE_MATH_H_FLOATS -DVERSION="2.2.0" -DQ_COMPONENTS_SYMBIAN -DQT_NO_DEBUG -DQT_DECLARATIVE_LIB -DQT_SQL_LIB -DQT_XMLPATTERNS_LIB -DQT_XML_LIB -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB
...
qmake:
	$(QMAKE) "C:/Pessoal/Projetos/Repositorio/checkmymeals/CheckMyMeals.pro"  -spec ..\..\..\..\QtSDK\Symbian\SDKs\Symbian3Qt474\mkspecs\symbian-sbsv2 CONFIG+=release -after  OBJECTS_DIR=obj MOC_DIR=moc UI_DIR=ui RCC_DIR=rcc
...
compiler_moc_header_make_all: moc\moc_qmlapplicationviewer.cpp moc\moc_cvisa.cpp moc\moc_cestudos.cpp moc\moc_ccartaomodel.cpp moc\moc_ccartaoitem.cpp moc\moc_ccompramodel.cpp moc\moc_ccompraitem.cpp moc\moc_cprocessador.cpp moc\moc_cartaoproxy.cpp moc\moc_cutil.cpp moc\moc_cmodelorelacaoutilizacao.cpp moc\moc_cmodelorelacaoutilizacaoitem.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc\moc_qmlapplicationviewer.cpp moc\moc_cvisa.cpp moc\moc_cestudos.cpp moc\moc_ccartaomodel.cpp moc\moc_ccartaoitem.cpp moc\moc_ccompramodel.cpp moc\moc_ccompraitem.cpp moc\moc_cprocessador.cpp moc\moc_cartaoproxy.cpp moc\moc_cutil.cpp moc\moc_cmodelorelacaoutilizacao.cpp moc\moc_cmodelorelacaoutilizacaoitem.cpp
...
moc\moc_cmodelorelacaoutilizacao.cpp: cmodelorelacaoutilizacaoitem.h \
		cmodelorelacaoutilizacao.h
	C:\QtSDK\Symbian\SDKs\Symbian3Qt474\bin\moc.exe $(DEFINES) $(INCPATH) -DSYMBIAN c:\Pessoal\Projetos\Repositorio\checkmymeals\cmodelorelacaoutilizacao.h -o c:\Pessoal\Projetos\Repositorio\checkmymeals\moc\moc_cmodelorelacaoutilizacao.cpp

moc\moc_cmodelorelacaoutilizacaoitem.cpp: cmodelorelacaoutilizacaoitem.h
	C:\QtSDK\Symbian\SDKs\Symbian3Qt474\bin\moc.exe $(DEFINES) $(INCPATH) -DSYMBIAN c:\Pessoal\Projetos\Repositorio\checkmymeals\cmodelorelacaoutilizacaoitem.h -o c:\Pessoal\Projetos\Repositorio\checkmymeals\moc\moc_cmodelorelacaoutilizacaoitem.cpp
